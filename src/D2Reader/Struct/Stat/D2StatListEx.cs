...
namespace Zutatensuppe.D2Reader.Struct.Stat
{
    ...
    public class D2StatListEx
    {
        ...
        [ExpectOffset(0x002C)] public DataPointer pLastList;   // 0x2C
        ...
        [ExpectOffset(0x003C)] public DataPointer pMyLastList; // 0x3C
        [ExpectOffset(0x0040)] public DataPointer pMyStats;    // 0x40
